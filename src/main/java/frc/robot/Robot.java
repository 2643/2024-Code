...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    if (isCurrentPos != Wrist.getPositionState() && RobotContainer.m_wrist.getWristState() == WristStates.INITIALIZED) {
      isCurrentPos = Wrist.getPositionState();
      CommandScheduler.getInstance().schedule(new WristMove(isCurrentPos));
    }
