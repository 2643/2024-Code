...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    if (isCurrentPos != ArmLift.getPositionState() && RobotContainer.m_armLift.getArmLiftState() == ArmLiftStates.INITIALIZED && RobotContainer.m_wrist.getWristState() == WristStates.INITIALIZED){
      isCurrentPos = ArmLift.getPositionState();
    ...
    if (isCurrentWristPos != Wrist.WristgetPositionState() && RobotContainer.m_wrist.getWristState() == WristStates.INITIALIZED && RobotContainer.m_armLift.getArmLiftState() == ArmLiftStates.INITIALIZED)  {
