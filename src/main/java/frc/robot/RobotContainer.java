...
public class RobotContainer {
  ...
  public Joystick js = new Joystick(Constants.jsID);
  public JoystickButton intakeButton = new JoystickButton(js, Constants.intakeButtonID);
  public JoystickButton outtakeButton = new JoystickButton(js, Constants.outtakeButtonID);
