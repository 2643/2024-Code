...
public class RobotContainer {
  ...
  // public static JoystickButton wristUp = new JoystickButton(operatorBoard, 5);
  // public static JoystickButton wristDown = new JoystickButton(operatorBoard, 3);
  public static JoystickButton floorIntake = new JoystickButton(operatorBoard, 2);
  public static JoystickButton ampOuttake = new JoystickButton(operatorBoard, 4);
  public static JoystickButton zeroGyro = new JoystickButton(operatorBoard, 8);


  // public static JoystickButton armUp = new JoystickButton(operatorBoard, 4);
  // public static JoystickButton armDown = new JoystickButton(operatorBoard, 2);
  public static JoystickButton snipeOuttake = new JoystickButton(operatorBoard, 3);

  // public JoystickButton intakeButton = new JoystickButton(operatorBoard, Constants.intakeButtonID);
  public JoystickButton outtakeButton = new JoystickButton(operatorBoard, 5);
  public static JoystickButton turnSwitch = new JoystickButton(operatorBoard, 105);
  public static JoystickButton autoAngleButton = new JoystickButton(operatorBoard, 100);
  public static JoystickButton boostButton = new JoystickButton(operatorBoard, 1);
  ...
  private void configureBindings() {
    ...
    floorIntake.onTrue(new ParallelCommandGroup(new FloorPosRoutine(), new Intake()));
    ampOuttake.onTrue(new AmpPosRoutine());

    snipeOuttake.onTrue(new SnipePosRoutine());

    floorIntake.onFalse(new ParallelCommandGroup(new RestPosRoutine(), new StopGrabber()));
    ampOuttake.onFalse(new RestPosRoutine());
    snipeOuttake.onFalse(new RestPosRoutine());
