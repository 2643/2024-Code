...
public class SpeakerRoutine extends SequentialCommandGroup {
    public SpeakerRoutine() {
        ...
        addCommands(new WaitCommand(0.5), new ResetPositionArm(), new ResetpositionWrist(), new WaitCommand(.5),new ArmMove(positionStates.SPEAKER), new WristMove(WristpositionStates.SPEAKER), new WaitCommand(1),
